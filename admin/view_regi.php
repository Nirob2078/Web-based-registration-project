                ...
                <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa-solid fa-people-group"></i><span class="hide-menu">Batches</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_batch.php"><i class="fa-solid fa-plus"></i>Add Batch</a></li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa-solid fa-graduation-cap"></i><span class="hide-menu">Course</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add-course.php"><i class="fa-solid fa-plus"></i> Add Course</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">All Registration</h3> </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT users.*, users_regi.* FROM users INNER JOIN users_regi ON users.u_id=users_regi.u_id where o_id='".$_GET['user_upd']."'";
											...
											<tr>
                                                    ...
                                                    <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('regi_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update ">
															 <button type="button" class="btn btn-primary">Update Status <i class="fa-solid fa-pen-to-square"></i></button></a>
															 </center></td>
											...
											<tr>
                                                    ...
                                                    <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update">
														<button type="button" class="btn btn-primary">View Student Details</button></a>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info" style="font-weight:bold;"><span  aria-hidden="true" >Submitted</button></center></td>
																		   <?php 
																			  }
																			...
																			if($status=="approved")
																				{
																			?>
																			<td>  <center>	 <button type="button" class="btn btn-success" style="background-color:#52BE80;border:none"><span  class="fa fa-check-circle" aria-hidden="true"></span>Approved</button> </center></td> 
																			<?php 
																			} 
																			?>
																			<?php
																			...
																			if($status=="withdraw")
																				{
																			?>
																			 <td>  <center><button type="button" class="btn btn-secondary" style="color:white; background-color:black"> withdraw <i class="fa-solid fa-arrow-right-from-bracket"></i></button></center></td> 
																			<?php 
																			} 
																			?>
