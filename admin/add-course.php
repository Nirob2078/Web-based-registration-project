...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/courses/".basename($fnew);                      // the path to store the upload image
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO courses(rs_id,title,slogan,price,img) VALUE('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show"  style ="color:black">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Done!</strong> Course Added.
															</div>';
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add New Course</h3> </div>
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Course for Batch</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                 ...
                                                 <label class="control-label">Course Name</label>
                                                    ...
                                                    <select class="form-control" id="exampleTextarea"  name="d_name" > 
                                                        <option value=""></option>
                                                            <option>CSI 231 ALgorithm</option>
                                                            <option>CSI 232	Algorithms Sessional</option>
                                                            <option>CSI 223 Database Management System</option>
                                                            <option>CSI 224	Database Management System Sessional</option>
                                                            <option>CSI 311	Visual & Internet Programming</option>
                                                            <option>CSI 312	Visual & Internet Programming Sessional</option>
                                                            <option>CSI 483	Machine Learning</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <select class="form-control" id="exampleTextarea"  name="about" > 
                                                        <option value=""></option>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" class="form-control" placeholder="Cr">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
