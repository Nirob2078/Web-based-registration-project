        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Registrations</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Student Registration</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT users.*, users_regi.* FROM users INNER JOIN users_regi ON users.u_id=users_regi.u_id ";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			{
																			?>
																			<td> <button type="button" class="btn btn-info" ><span   aria-hidden="true" >Pending <i class="fa-regular fa-clock"></i></button></td>
																		   <?php 
																			  }
																			...
																			if($status=="approved")
																				{
																			?>
																			<td> <button type="button" class="btn btn-success" style="background-color:#52BE80;border:none"><span  class="fa fa-check-circle" aria-hidden="true"></span>Approved</button> </td> 
																			<?php 
																			} 
																			?>
																			<?php
																			...
																			?>
																			<td>
																			 <button type="button" class="btn btn-secondary" style="color:white; background-color:black"> withdraw <i class="fa-solid fa-arrow-right-from-bracket"></i></button></td> 
																			<?php 
																			} 
																			?>
																						...
																						<?php																									
																							...
																							?>
																									 <td>
																									 <a href="delete_regi.php?order_del=<?php echo $rows['o_id'];?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								<?php
																								echo '<a href="view_regi.php?user_upd='.$rows['o_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa-solid fa-pen-to-square"></i></a>
																									</td>
																									</tr>';
