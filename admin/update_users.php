...
if(isset($_POST['submit'] ))
{
	...
	mysqli_query($db, $mql);
			$success = 	'<div class="alert alert-dismissible fade show" style="color: #2ECC71 ; background-color:#fff;  box-shadow: 3px 3px #888888;">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Student Info Updated!</strong></div>';
        ...
        <div class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa-solid fa-people-group"></i></i><span class="hide-menu">Batches</span></a>
                            <ul aria-expanded="false" class="collapse">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa-solid fa-graduation-cap"></i><span class="hide-menu">Course</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_menu.php">All course</a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Student Information</h3> </div>
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Student</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <form action='' method='post'  >
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="uname" class="form-control" value="<?php  echo $newrow['username']; ?>" placeholder="CSE...">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Studnet Batch</label>
                                                    <input type="text" name="lname" class="form-control" placeholder="69"  value="<?php  echo $newrow['address']; ?>">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
