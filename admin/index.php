...
<div class="container">
  <div class="info">
    <h1>Admin</h1><span>Only for Authority</span>
  </div>
</div>
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
   ...
   <input type="submit"  name="submit1" value="Create" />
    <p class="message" style="color:black">Already registered? <a href="#" style="color: blue;">Sign In</a></p>
  </form>
  ...
  <form class="login-form" action="index.php" method="post">
    ...
    <p class="message" style="color: black;">Not registered? <a href="#" style="color: blue;">Create an Admin account</a></p>
  </form>
