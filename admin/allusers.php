        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">All Student Information</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Registered Student</h4>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['username'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 ...
																									 <a href="update_users.php?user_upd='.$rows['u_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa-solid fa-pen-to-square"></i></a>
																									</td></tr>';
            ...
            <!-- footer -->
            <footer class="footer">  @<b><a href="">Hridoy Hossain</a></b> CSE06908025
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
