            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa-solid fa-file"></i><span class="hide-menu">Registrations</span></a>
                            <ul aria-expanded="false" class="collapse">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">All Batch Informations</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Registered Batch</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%" >
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM batch order by rs_id desc";
												$query=mysqli_query($db,$sql);
												
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No Batch Data</center></td>';
														}
													else
														{				
																				...
																				$mql="SELECT * FROM res_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr style="text-align:center">
                                                                                               ...
                                                                                               <td>'.$rows['title'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete_batch.php?res_del='.$rows['rs_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
