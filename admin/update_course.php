					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update courses set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show" style="color:black">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Course </strong>Updated.
															</div>';
                ...
                <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa-solid fa-people-group"></i><span class="hide-menu">Batches</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_restraunt.php"><i class="fa-solid fa-plus"></i>Add Batch</a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Course Informations</h3> </div>
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php $qml ="select * from courses where d_id='$_GET[menu_upd]'";
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <select class="form-control" id="exampleTextarea"  name="about"> 
                                                        <option ><?php echo $roww['slogan'];?></option>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" value="<?php echo $roww['price'];?>"  class="form-control" placeholder="(Hr)">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="file" name="file" value="<?php echo $roww['price'];?>"  id="lastName" class="form-control form-control-danger" placeholder="">
                                                    </div>
                                            </div>
                                        </div>
                                        <!--/row-->
